## Exercise: Validate Dev Environment

To install, download or clone the repo, then move to the required exercise folder with either and for each exercise run:
...
Add code to make truffle test go from failing to passing to validate your dev environment
